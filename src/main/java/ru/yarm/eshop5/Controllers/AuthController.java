...
//Наша точка входа - страница авторизации
//На странице Авторизации будет предусмотрена возможность регистрации нового пользователя
//Для этого предусмотрим отсылку
//МоделАтрибут - положит в user - пустого человека!!!
